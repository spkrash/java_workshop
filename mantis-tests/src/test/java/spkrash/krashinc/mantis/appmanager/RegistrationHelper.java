...
public class RegistrationHelper extends HelperBase {
   ...
   public void resetPassword(String username) {
      clickItem(By.linkText(username));
      clickItem(By.xpath("//*[@id=\"manage-user-reset-form\"]/fieldset/span/input"));   //xpath по той же причине что и выше
   }

   public void logout() {
      clickItem(By.cssSelector("a[href*='logout_page.php']"));
   }
}
